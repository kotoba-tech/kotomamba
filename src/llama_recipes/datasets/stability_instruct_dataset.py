...
from llama_recipes.configs.datasets import stability_instruct_dataset
...
class StabilityInstructDataset(Dataset):
    def __init__(
        self,
        dataset_config: Type[stability_instruct_dataset],
