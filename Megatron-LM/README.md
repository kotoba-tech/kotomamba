...
python tools/preprocess_data.py \
       --input /groups/gcd50698/fujii/datasets/pile/merged/merged_valid.jsonl \
       --output-prefix /groups/gcd50698/fujii/datasets/pile/bin/pile-mamba-validation \
       --tokenizer-type MambaTokenizer \
       --workers 16  \
       --append-eod  

python tools/preprocess_data.py \
       --input /groups/gcd50698/fujii/datasets/pile/merged/merged.jsonl \
       --output-prefix /groups/gcd50698/fujii/datasets/pile/bin/pile-mamba-train \
       --tokenizer-type MambaTokenizer \
       --workers 32  \
       --append-eod  
